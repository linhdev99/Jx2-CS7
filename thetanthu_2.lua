...
local tb_translife_weapon_effect = {			
			"Hµo m«n",
			"PhÇn V©n",
			"§o¹n Giao",			
			"Ph¸ Qu©n",
}
local tb_translife_cloth_cs6_nhanlai = {
			[1] = {
...
local tb_translife_cloth_cs7_nhanlai = {
			[1] = {
